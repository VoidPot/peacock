...
-- CreateEnum
CREATE TYPE "SUMMARY_TYPE" AS ENUM ('DEFAULT', 'GROUP', 'MEMBER', 'VENDOR', 'ALL_GROUP', 'ALL_MEMBER', 'ALL_VENDOR');

-- CreateEnum
CREATE TYPE "PASSBOOK_ENTRY_OF" AS ENUM ('USER', 'GROUP', 'USER_GROUP', 'CLUB');
...
CREATE TABLE "Passbook" (
    ...
    "termWithdraw" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "withdraw" DOUBLE PRECISION NOT NULL DEFAULT 0,
